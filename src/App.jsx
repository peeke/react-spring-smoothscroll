...
import { useSmooshScroll, useSmooshScrollDocument } from "../lib/react";
...
export default function App() {
  ...
  return (
    <div className="App">
      ...
      <p>
        <a href="#anchor">Lorem Ipsum</a> is simply dummy text of the printing
      ...
      <div ref={smooshRef} className="App-nested">
        <p>
      ...
      <p>
        ...
        <a href="https://google.com">Richard McClintock</a>, a Latin professor
      ...
      <h2 id="anchor" style={{ scrollMarginTop: "128px" }}>
        <strong>#anchor</strong>: Where can I get some?
      </h2>
      <p>
        Contrary to popular belief, Lorem Ipsum is not simply random text. It
        has roots in a piece of classical Latin literature from 45 BC, making
